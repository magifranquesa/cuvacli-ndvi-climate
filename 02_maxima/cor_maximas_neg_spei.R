# ==============================================================================
# CORRELACIÓN NEGATIVA MÁXIMA ENTRE ESCALAS DEL SPEI
# ==============================================================================
# Para cada parque, índice (NDVI, kNDVI), píxel y mes, selecciona entre las
# cinco escalas del SPEI (1, 3, 6, 9, 12 meses) la correlación más baja (la
# negativa más fuerte), y guarda con ella la escala, su p-valor sin corregir,
# su código de significancia y el número de años válidos.
#
...
# Salida : correlaciones_v2/maximos_cor_negative/<parque>_max_neg_correlation_spei_<indice>.nc
...
for (index in indices) {
  for (parque in parques) {
    ...
    outfile <- file.path(output_dir, paste0(parque, "_max_neg_correlation_spei_", tolower(index), ".nc"))
