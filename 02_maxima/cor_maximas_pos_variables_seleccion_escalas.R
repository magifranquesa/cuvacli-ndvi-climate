# ==============================================================================
# CORRELACIÓN POSITIVA MÁXIMA ENTRE ESCALAS DE ACUMULACIÓN (Tmax, Tmin, Pr)
# ==============================================================================
...
# más alta, y guarda con ella la escala en que ocurre, su p-valor sin corregir,
...
# Salida : correlaciones_v2/maximos_cor_positive/<parque>_max_pos_correlation_<var>_<indice>_selscales.nc
...
for (parque in parques) {
  ...
  for (index in indices) {
    for (var in variables) {
      ...
      outfile <- file.path(output_dir, sprintf("%s_max_pos_correlation_%s_%s_selscales.nc", parque, var, tolower(index)))
