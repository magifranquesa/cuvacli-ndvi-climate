# ================================================================================
# UMBRAL DE AÑOS VÁLIDOS Y CONTROL DEL FDR — CORRELACIONES NEGATIVAS
# ================================================================================
# Se ejecuta después de los scripts de máximos (02_maxima/). Lee
# maximos_cor_negative/ y escribe maximos_cor_negative_fdr/ con los mismos
...
#
# Este script y fdr_postproceso_pos.R son idénticos salvo DIR_ENTRADA,
# DIR_SALIDA y SIGNO.
#
# Entrada: correlaciones_v2/maximos_cor_negative/<parque>_max_neg_correlation_<var>_<indice>[_selscales].nc
# Salida : correlaciones_v2/maximos_cor_negative_fdr/  (mismos nombres)
# ================================================================================
...
# CONFIGURACIÓN
# --------------------------------------------------------------------------------
DIR_ENTRADA <- paste0(ROOT, '/articulo_2/correlaciones_v2/maximos_cor_negative/')
DIR_SALIDA  <- paste0(ROOT, '/articulo_2/correlaciones_v2/maximos_cor_negative_fdr/')
SIGNO       <- "neg"
