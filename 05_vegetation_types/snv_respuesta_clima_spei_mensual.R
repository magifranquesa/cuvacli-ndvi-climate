# ==============================================================================
# CORRELACIONES POSITIVAS SIGNIFICATIVAS NDVI-SPEI POR TIPO DE VEGETACIÓN
# ==============================================================================
# Para cada parque, escala del SPEI (1, 3, 6, 9, 12) y mes,
# cuenta los píxeles de cada tipo de vegetación (Id_SNVeg, Sistemas Naturales
# de Vegetación) y cuántos de ellos tienen correlación positiva significativa.
#
...
# Salida  : resultados_v2/snv_respuesta_clima_mensual_positivo_<indice>_<var>.csv
...
cat(sprintf("=== SNV positivas | indice=%s | n>=%d | FDR q=%.2f ===\n", indice, N_MIN, Q_FDR))
...
for (var in variables) {
  ...
  out_csv <- file.path(out_dir, paste0("snv_respuesta_clima_mensual_positivo_", indice, "_", var, ".csv"))
