# ==============================================================================
# CORRELACIONES POSITIVAS MÁXIMAS POR TIPO DE VEGETACIÓN Y ESCALA (Tmax, Tmin, Pr)
# ==============================================================================
# Para cada variable, parque, mes y tipo de vegetación (Id_SNVeg), cuenta los
# píxeles válidos del tipo y, de ellos, los que tienen correlación positiva
...
# Salida  : resultados_v2/snv_respuesta_<var>_<indice>_absoluto_positivo.csv
...
for (variable in variables) {
  ...
  for (parque in parques) {
    ...
    # Archivos
    nc_path <- file.path(base_nc, sprintf("%s_max_pos_correlation_%s_%s_selscales.nc", parque, variable, indice))
  ...
  output_csv <- sprintf(paste0(ROOT, "/articulo_2/resultados_v2/snv_respuesta_%s_%s_absoluto_positivo.csv"), variable, indice)
